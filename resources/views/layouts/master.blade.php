...
<head>
  ...
  <title>{{auth()->user()->name}}|Laundry Abidin</title>
  ...
  <div id="app">
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto" method="GET" action="/pakets">
     ...
     <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Laundry Abidin</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="/dashboard" class=""><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
          ...
          <li><a href="/dashboard" class=""><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
          <li><a href="{{ url('laporans') }}" class=""><i class="fa fa-book"></i> <span>Laporan</span></a></li>
        @endif
        </aside>
      </div>
